...
import java.net.URL;
public class SCNBioskoponline5Test {
  ...
  @Test
  public void sCNBioskoponline5() {
    // Test name: SCN_Bioskop online_5
    ...
    // 6 | click | css=.w-full > .font-bold | 
    // Memastikan button masuk disable ketika hanya menginputkan username
    driver.findElement(By.cssSelector(".w-full > .font-bold")).click();
  }
}
